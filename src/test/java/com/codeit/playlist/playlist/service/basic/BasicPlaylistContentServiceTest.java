...
public class BasicPlaylistContentServiceTest {
    ...
    void addContentToPlaylist_fail_playlistNotFound() {
        // given
        given(playlistRepository.findByIdAndDeletedAtIsNull(PLAYLIST_ID))
    ...
    void addContentToPlaylist_fail_notOwner() {
        // given
        Playlist playlist = mock(Playlist.class);
        User owner = mock(User.class);
    ...
    void addContentToPlaylist_fail_contentNotFound() {
        // given
        Playlist playlist = mock(Playlist.class);
        User owner = mock(User.class);
    ...
    void addContentToPlaylist_fail_alreadyExists() {
        // given
        Playlist playlist = mock(Playlist.class);
        User owner = mock(User.class);
        Content content = mock(Content.class);
